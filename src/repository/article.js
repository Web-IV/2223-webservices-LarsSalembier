 ...
 *
 * @returns {Promise<number>} id of the newly created article
 */
 ...
 * @param {string} article.content the content of the article
 *
 * @returns {Promise<number>} the id of the updated article
 */
 ...
 * @param {number} id the id of the article
 *
 * @returns {Promise<boolean>} true if the article was deleted, false otherwise
 */
